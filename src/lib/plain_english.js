const REPLACEMENTS = [
  ...
  [/\bmultiple expansion\b/gi, 'rising valuations'],
  [/\bmultiple compression\b/gi, 'falling valuations'],
  [/\b(?:valuation|p\/e|pe|forward|earnings)\s+multiples?\b/gi, 'valuations'],
